...
import {mainGreen} from "./../../tailwind.config";
      ...
      <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
        ...
        <div className="relative max-w-md px-4 mx-auto border-0 sm:max-w-3xl sm:px-6 lg:px-0">
          <div className="lg:pt-20">
            <h2 className="text-3xl font-medium tracking-tight text-center text-green-700 sm:text-5xl lg:text-left">
              On a Mission to
              <br />
              Help Those In Need
            </h2>
            <div className="mt-6 space-y-2 text-green-500">
          ...
          <div className="mt-10 text-center lg:text-left">
            <Link href="/about">
              <a className="text-base font-medium transition-colors text-fourthGreen hover:text-primary-700">
